...
Secure password manager and generator with biometric authentication and encrypted storage

## 📱 App Information

- **Package Name:** `com.lehau.PasswordGuardian`
- **Category:** security
...
1. Clone this repository:
   ```bash
   git clone https://github.com/linhfishCR7/PasswordGuardian.git
   cd PasswordGuardian
   ```
